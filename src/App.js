      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full">
          <div className="flex justify-between items-center mb-6 gap-4">
            <div className="h-12 w-32 bg-red-600 rounded flex items-center justify-center text-white text-xs font-bold">Brannvern</div>
            <div className="h-12 w-32 bg-blue-900 rounded flex items-center justify-center text-white text-xs font-bold">Finans Norge</div>
          </div>
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg" id="checklist-content">
        <div className="p-6 border-b">
          <div className="flex justify-between items-center mb-4">
            <div className="h-10 w-32 bg-red-600 rounded flex items-center justify-center text-white text-xs font-bold">Brannvern</div>
            ...
            <div className="h-10 w-32 bg-blue-900 rounded flex items-center justify-center text-white text-xs font-bold">Finans Norge</div>
          </div>
